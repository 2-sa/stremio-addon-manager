...
<template>
  <button type="button" class="theme-btn icon-only" @click="toggleMode" :aria-label="darkEnabled ? 'تبديل للوضع النهاري Light Mode' : 'تبديل للوضع الليلي Dark Mode'" :title="darkEnabled ? 'تبديل للوضع النهاري Light Mode' : 'تبديل للوضع الليلي Dark Mode'">
