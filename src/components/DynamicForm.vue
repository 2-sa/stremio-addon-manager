    ...
    <form @submit.prevent="handleSubmit">
        <div v-if="!isAdvancedMode">
            ...
            <div v-if="formModel.catalogs && formModel.catalogs.length > 0" class="form-group">
                ...
                <div v-for="(catalog, index) in formModel.catalogs" :key="catalog.type" class="catalog-item">
                    ...
                    <input
                        ...
                        :placeholder="$t('dynamicForm.catalogName')"
                    />
            ...
            <div class="form-actions">
                <button class="save-button" type="submit">{{ $t('dynamicForm.save') }}</button>
                <button type="button" class="switch-mode-button" @click="toggleEditMode">{{ $t('dynamicForm.advancedMode') }}</button>
            </div>
        </div>
        ...
        <div v-else>
            ...
            <div class="form-actions">
                <button class="save-button" type="button" @click="updateFromJson">{{ $t('dynamicForm.save') }}</button>
                <button type="button" class="switch-mode-button" @click="toggleEditMode">{{ $t('dynamicForm.classicMode') }}</button>
            </div>
        </div>
    </form>
</template>
